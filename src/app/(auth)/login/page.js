          ...
          <div>
            ...
            <div className="mt-2">
              <input type="text" id="email" placeholder="example@gmail.com"
                     className="block w-full appearance-none rounded-md border bg-white px-3 py-3 leading-normal border-primary-300 focus:shadow-outline focus:border-primary-600 focus:outline-none"/>
            </div>
          </div>
